...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        if(!empty($username) && !empty($email) && !empty($password) && !empty($firstname) && !empty($firstname)) {
            ...
            $query .= "VALUES('{$firstname}','{$lastname}','{$username}', '{$email}', '{$password}', 'subdcriber' )";
            ...
            $message = "Your Registration has been complited";
        } else {
            
            $message = "You cannot left it Empty";
        } 
